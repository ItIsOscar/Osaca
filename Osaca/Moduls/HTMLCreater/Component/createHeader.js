...
export function createHeader() {
    ...
    let firstLineHeader = createElementAndProperty("div", header, "header_firstLine")
    ...
    let logo = createElementAndProperty("a", firstLineHeader, "header_logo", ["id", "href"], ["butProfile", "/profile"])
    ...
    let secondLineHeader = createElementAndProperty("nav", header, "header_secondLine")
